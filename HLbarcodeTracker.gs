function copyDataToProduction() {
  // Source file
  var sourceFile = SpreadsheetApp.openById("1nUc7rCjPxid-PGHln6V0JXLVGxRxPSwNsZjZ0JPtcp8"); // Replace with the ID of your source file
  var sourceSheet = sourceFile.getSheetByName("Production Helper");

  // Destination file
  var destFile = SpreadsheetApp.openById("12-AsQY3OV5GqLU6zVldNXax1tSX51Wo_akUiJwv4Bdc"); // Replace with the ID of your destination file
